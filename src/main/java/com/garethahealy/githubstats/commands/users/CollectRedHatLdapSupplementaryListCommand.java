...
public class CollectRedHatLdapSupplementaryListCommand implements Runnable {
    ...
    @CommandLine.Option(names = {"-s", "--supplementary-csv"}, description = "CSV of current known members, generated by this command previously", required = true)
    ...
    public void run() {
        try {
            collectRedHatLdapSupplementaryListService.run(organization, output, membersCsv, supplementaryCsv, shouldGuess, failNoVpn);
